  ...
  return (
    <div>
      ...
      <div className="flex justify-between mt-2 mb-3">
        ...
        <button disabled={!next} className="py-2 px-8 rounded bg-slate-50 hover:bg-slate-200 border-black">
          <Link href={'/task/' + next} property="og:url" itemProp="url">Next</Link>
        </button>
      </div>
